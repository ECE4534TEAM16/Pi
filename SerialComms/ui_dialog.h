...
public:
    ...
    void retranslateUi(QDialog *Dialog)
    {
        ...
        temp_label->setText(QApplication::translate("Dialog", "<html><head/><body><p><span style=\" font-size:22pt; font-weight:600; color:#ff0000;\">Temperature</span></p></body></html>", 0));
    } // retranslateUi
